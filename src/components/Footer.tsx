import { Linkedin, Twitter, Send, Instagram, Mail, Phone, MapPin } from 'lucide-react';
...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#172A45] text-white">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="space-y-3 text-[#DCE3E8]">
              <div className="flex items-center space-x-3">
                <Mail className="w-5 h-5 text-[#6C7A89]" />
                <span>contact@equityflow.com</span>
              </div>
              <div className="flex items-center space-x-3">
                <Phone className="w-5 h-5 text-[#6C7A89]" />
                <span>+1 (555) 123-4567</span>
              </div>
              <div className="flex items-center space-x-3">
                <MapPin className="w-5 h-5 text-[#6C7A89]" />
              ...
              {socialLinks.map((social, index) => {
                ...
                return (
                  <a
                    ...
                    className="w-10 h-10 bg-[#274060] rounded-lg flex items-center justify-center hover:bg-[#3A5A7A] transition-colors duration-200"
                  >
            ...
            <ul className="space-y-3">
              {footerLinks.company.map((link, index) => (
                <li key={index}>
                  <a
                    href={link.href}
                    className="text-[#DCE3E8] hover:text-[#3A5A7A] transition-colors duration-200"
                  >
                    {link.name}
                  </a>
                </li>
