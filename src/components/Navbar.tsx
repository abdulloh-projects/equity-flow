      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden lg:flex items-center space-x-4">
            ...
            <button 
              onClick={() => onNavigate && onNavigate('control-panel')}
              className="flex items-center bg-[#274060] text-white rounded-lg hover:bg-[#3A5A7A] transition-colors duration-200 font-medium ml-[0px] mr-[16px] my-[0px] px-[12px] py-[6px]"
            >
              {/* Founder Avatar */}
            ...
            <div className="relative">
              ...
              >
                ...
                <ChevronDown className={`w-4 h-4 text-[#0F1720] transition-transform duration-200 ${isLanguageDropdownOpen ? 'rotate-180' : ''}`} />
              </button>
              
              {/* Dropdown Menu */}
              {isLanguageDropdownOpen && (
                <div className="absolute right-0 mt-2 w-24 bg-white border border-[#DCE3E8] rounded-lg shadow-lg overflow-hidden">
                  {['EN', 'RU', 'UZ'].map((lang) => (
                    <button
                      key={lang}
                      onClick={() => {
