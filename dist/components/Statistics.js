...
function Statistics() {
    ...
    return (<section className="py-20 bg-gradient-to-br from-[#F5F7FA] to-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {stats.map((stat, index) => {
            ...
            return (<StatCard key={index} {...stat} IconComponent={IconComponent}/>);
        })}
        </div>
      </div>
    </section>);
}
function StatCard({ IconComponent, end, label, prefix = '', suffix = '' }) {
    ...
    return (<div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 border border-[#DCE3E8] hover:border-[#274060] group">
