...
function Navbar({ currentPage = "home", onNavigate, isAuthenticated: isAuthProp, userRole: userRoleProp, }) {
    var _a, _b, _c, _d, _e;
    ...
    const isAuthenticated = (_b = (_a = auth.isAuthenticated) !== null && _a !== void 0 ? _a : isAuthProp) !== null && _b !== void 0 ? _b : false;
    const userRole = (_e = (_d = (_c = auth.user) === null || _c === void 0 ? void 0 : _c.role) !== null && _d !== void 0 ? _d : userRoleProp) !== null && _e !== void 0 ? _e : "";
    const navLinks = [
    ...
    return (<nav className="sticky top-0 z-50 bg-white shadow-sm border-b border-[#DCE3E8]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <>
                {/* Dashboard Button */}
                <button onClick={handleDashboardClick} className="flex items-center bg-[#274060] text-white rounded-lg hover:bg-[#3A5A7A] transition-colors duration-200 font-medium px-3 py-1.5">
                ...
                {/* Logout Button */}
                <button onClick={handleLogout} className="flex items-center gap-2 px-3 py-2 border border-[#DCE3E8] rounded-lg text-[#0F1720] hover:border-red-400 hover:text-red-600 transition-colors duration-200 text-sm font-medium">
        ...
        /* Guest state */
        <>
                <button onClick={() => onNavigate === null || onNavigate === void 0 ? void 0 : onNavigate("login")} className="text-[#0F1720] hover:text-[#274060] transition-colors duration-200 font-medium">
                  Sign In
                </button>
                <button onClick={() => onNavigate === null || onNavigate === void 0 ? void 0 : onNavigate("register")} className="px-4 py-2 bg-[#274060] text-white rounded-lg hover:bg-[#3A5A7A] transition-colors duration-200 font-medium">
                  Get Started
                </button>
              </>)}
            ...
            <div className="relative">
              ...
              {/* Dropdown Menu */}
              {isLanguageDropdownOpen && (<div className="absolute right-0 mt-2 w-24 bg-white border border-[#DCE3E8] rounded-lg shadow-lg overflow-hidden z-10">
          ...
          <div className="px-4 py-4 space-y-3">
            ...
            <div className="pt-4 border-t border-[#DCE3E8] space-y-3">
              {isAuthenticated ? (<>
                  ...
                  <button onClick={handleDashboardClick} className="w-full flex items-center justify-center space-x-3 px-6 py-2 bg-[#274060] text-white rounded-lg hover:bg-[#3A5A7A] transition-colors duration-200 font-medium">
                  ...
                  {/* Logout - Mobile */}
                  <button onClick={handleLogout} className="w-full flex items-center justify-center gap-2 px-6 py-2 border border-red-300 text-red-600 rounded-lg hover:bg-red-50 transition-colors duration-200 font-medium">
                    <lucide_react_1.LogOut className="w-4 h-4"/>
                    Log Out
                  </button>
                </>) : (<>
                  ...
                  <button onClick={() => {
                    onNavigate === null || onNavigate === void 0 ? void 0 : onNavigate("register");
                    setIsMenuOpen(false);
