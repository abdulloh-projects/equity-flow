...
const react_hook_form_7_55_0_1 = require("react-hook-form@7.55.0");
const utils_1 = require("./utils");
const label_1 = require("./label");
const Form = react_hook_form_7_55_0_1.FormProvider;
exports.Form = Form;
const FormFieldContext = React.createContext({});
const FormField = (_a) => {
    var props = __rest(_a, []);
    return (<FormFieldContext.Provider value={{ name: props.name }}>
      <react_hook_form_7_55_0_1.Controller {...props}/>
...
const useFormField = () => {
    ...
    const { getFieldState } = (0, react_hook_form_7_55_0_1.useFormContext)();
    const formState = (0, react_hook_form_7_55_0_1.useFormState)({ name: fieldContext.name });
...
function FormControl(_a) {
    ...
    return (<react_slot_1_1_2_1.Slot data-slot="form-control" id={formItemId} aria-describedby={!error
            ? `${formDescriptionId}`
