...
function InputOTP(_a) {
    ...
    return (<input_otp_1_4_2_1.OTPInput data-slot="input-otp" containerClassName={(0, utils_1.cn)("flex items-center gap-2 has-disabled:opacity-50", containerClassName)} className={(0, utils_1.cn)("disabled:cursor-not-allowed", className)} {...props}/>);
}
...
function InputOTPSeparator(_a) {
    ...
    return (<div data-slot="input-otp-separator" role="separator" {...props}>
      <lucide_react_0_487_0_1.MinusIcon />
    </div>);
}
