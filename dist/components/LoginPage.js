...
function LoginPage({ onBackToHome, onNavigate, }) {
    ...
    return (<div className="min-h-screen bg-white flex flex-col">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center gap-6">
              ...
              {/* Back to Home */}
              <button onClick={onBackToHome} className="flex items-center gap-2 text-[#274060] hover:text-[#3A5A7A] transition-colors duration-200 font-medium">
        ...
        <div className="flex-1 flex items-center justify-center px-4 sm:px-6 lg:px-8 py-12">
          <div className="w-full max-w-md">
            ...
            <div className="bg-white rounded-2xl shadow-xl border border-[#DCE3E8] p-8 lg:p-10">
              ...
              <form className="space-y-6" onSubmit={handleSubmit}>
                ...
                <div className="space-y-3">
                  <div className="flex items-center">
                    <input id="remember-me" name="remember-me" type="checkbox" checked={rememberMe} onChange={(e) => setRememberMe(e.target.checked)} className="h-4 w-4 text-[#274060] focus:ring-[#274060] border-[#DCE3E8] rounded cursor-pointer"/>
              ...
              <div className="space-y-3">
                {/* Google Login */}
                <button type="button" className="w-full py-3 px-4 border-2 border-[#274060] text-[#274060] font-medium rounded-lg hover:bg-[#274060] hover:text-white transition-all duration-200 flex items-center justify-center gap-3">
      ...
      {/* 2FA Modal */}
      {show2FAModal && (<div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 px-4">
          <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full p-8 relative">
            {/* Close Button */}
            <button onClick={() => setShow2FAModal(false)} className="absolute top-4 right-4 text-[#0F1720] opacity-60 hover:opacity-100 transition-opacity duration-200">
