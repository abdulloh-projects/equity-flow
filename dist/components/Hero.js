...
function Hero() {
    return (<section className="relative bg-gradient-to-br from-white to-[#F5F7FA] py-20 lg:py-28">
          ...
          <div className="space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <button className="group px-6 py-4 bg-white text-[#274060] border-2 border-[#274060] rounded-xl hover:bg-[#274060] hover:text-white transition-all duration-300 hover:px-8 hover:shadow-xl flex items-center justify-center space-x-2">
                ...
                <lucide_react_1.ArrowRight className="w-0 h-6 opacity-0 group-hover:w-6 group-hover:opacity-100 transition-all duration-300"/>
              </button>
              <button className="group px-6 py-4 bg-white text-[#274060] border-2 border-[#274060] rounded-xl hover:bg-[#274060] hover:text-white transition-all duration-300 hover:px-8 hover:shadow-xl flex items-center justify-center space-x-2">
